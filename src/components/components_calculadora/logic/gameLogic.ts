...
export const iniciarProximoJogo = (jogos: CampoType[][], setJogos: React.Dispatch<React.SetStateAction<CampoType[][]>>) => {
  ...
  if (campo1 && campo2 && campo3) {
    ...
    // Vencedores e perdedores do campo 3
    ...
    vencedoresCampo3.forEach(jogador => {
      jogador.vitorias += 1;
    ...
    // Campo 2: vencedores do campo 2 e vencedores do campo 3
    novosCampos[1].times.push(
      { jogadores: [vencedoresCampo2[0], vencedoresCampo3[0]], resultado: 0 },
      { jogadores: [vencedoresCampo2[1], vencedoresCampo3[1]], resultado: 0 }
    );

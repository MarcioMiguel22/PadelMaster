...
import padelImage from './Quieres-saber-cuáles-son-los-beneficios-del-pádel-y-porque-es-importante-praticarlo.jpg'; // Certifique-se de que o caminho está correto

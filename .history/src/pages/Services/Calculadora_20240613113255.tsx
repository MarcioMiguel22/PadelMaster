...
const CalculadoraApp: React.FC = () => {
  ...
  const jogadoresPorColuna = Math.ceil(jogadores.length / 3);
  ...
  return (
    <div className="calculadora-container">
      ...
      <div className="jogadores-lista">
        {[0, 1, 2].map(col => (
          <div key={col} className="jogadores-coluna">
            {jogadores.slice(col * jogadoresPorColuna, (col + 1) * jogadoresPorColuna).map(jogador => (

...
const CalculadoraApp: React.FC = () => {
  ...
  const [jogadoresSelecionados, setJogadoresSelecionados] = useState<Jogador[]>([]); // Estado para jogadores selecionados
    ...
    <div className="calculadora-container">
      ...
      <div className="main-content">
        ...
        <div id="ranking-resultados">
          ...
          {todosResultadosInseridos && <ResetButton onReset={resetGame} />} {/* Mostrar botão de reset apenas se todos os resultados foram inseridos */}
        </div>

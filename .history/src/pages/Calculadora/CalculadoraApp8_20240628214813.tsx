...
import PlayerSelector from '../../components/components_calculadora/JogadoresLista8';
...
const CalculadoraApp8: React.FC = () => {
  ...
  const handleTrocarJogadores = () => {
    const novosJogos = trocarJogadores8(jogos); // Alterado para passar apenas um argumento
    setJogos(novosJogos);
  };

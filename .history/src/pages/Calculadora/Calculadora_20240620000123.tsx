...
import { criarTimes, criarCampos, atualizarRanking } from '../../utils/gameLogic'; // Importe as funções de lógica do jogo
import { embaralharArray } from '../../utils/utils'; // Importe a função de utilitário

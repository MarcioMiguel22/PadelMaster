...
const CalculadoraApp6: React.FC = () => {
  ...
  const [jogadoresEsperando, setJogadoresEsperando] = useState<Jogador[]>([]);
  ...
  const handleTrocarJogadores = (campoId: number) => {
    const novosJogos = trocarJogadores6(jogos, campoId, jogadoresEsperando);
    setJogos(novosJogos);

...
import { criarTimes6, criarCampos6, atualizarRanking6, trocarJogadores6, iniciarProximoJogo6 } from '../../utils/utils6';
import { handleNomeChange, selecionarJogador } from '../../utils/playerUtils';
import { todosResultadosInseridos6 } from '../../utils/utils6';
...
const CalculadoraApp6: React.FC = () => {
  ...
  const distribuirJogadores = () => {
    ...
    const novosCampos = criarCampos6(times);

...
export const embaralharArray4 = <T,>(array: T[]): T[] => {
...
export const criarTimes4 = (jogadores: Jogador[]): Time[] => {
  const jogadoresEmbaralhados = embaralharArray4(jogadores);
  const times: Time[] = [];
...
export const criarCampos4 = (times: Time[]): CampoType[] => [
  { id: 1, times: times.slice(0, 2) },
];

export const atualizarRanking4 = (jogadores: Jogador[], jogos: CampoType[][]) => {
...
export const todosResultadosInseridos4 = (jogos: CampoType[][]): boolean => {
...
// Implementação das funções trocarJogadores4 e iniciarProximoJogo4
export const trocarJogadores4 = (jogos: CampoType[][], campoId: number): CampoType[][] => {
...
export const iniciarProximoJogo4 = (jogos: CampoType[][]): CampoType[][] => {

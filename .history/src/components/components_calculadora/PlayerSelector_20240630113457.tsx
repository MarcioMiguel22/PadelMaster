...
const PlayerSelector: React.FC = () => {
  ...
  return (
    <div className={styles.selectorContainer}>
      ...
      <div className={`${styles.option} ${isActivePage(6) ? styles.active : ''}`} onClick={() => handleNavigation(6)}>
        <div className={styles.bolaContainer}>
          {isActivePage(6) && <img src={tennisBall} alt="6 Jogadores" className={styles.bola} />}
        </div>
        <div className={styles.optionText}>6 Jogadores</div>
      </div>
